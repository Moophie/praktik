...
@section('content')
    ...
    <div class="Wrapper bg-light">
        ...
        <form class="form-group" action="/updateinfo" method="POST">
            ...
            <textarea class="form-control" name="inleiding" id="inleiding" cols="30" rows="10" placeholder="Write something about yourself!">{{ Auth::user()->inleiding  }}</textarea>
            ...
            <input class="form-control" type="text" name="taalvoorkeur" id="taalvoorkeur" value="{{ Auth::user()->taalvoorkeur }}">
